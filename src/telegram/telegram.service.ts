...
هدف این ربات کمک به شما برای مدیریت روزانه کارهایتان مثل درس خوندن، رفتن به باشگاه و ... با توجه به برنامه قطعی برق است.
...
این ربات به شما کمک می‌کند تا با اطلاع از برنامه قطعی برق، برنامه روزانه خود مثل مطالعه، ورزش و سایر کارها را بهتر مدیریت کنید.
